...
<tr class="rowtwo" valign="top">
    ...
    <td>
        <?php echo $form->dropDownList($model, 'id_level', $data_id_level, array( 'class' => 'inp')); ?>
      </td>
</tr>
<tr class="rowone" valign="top">
    <td>
...
<tr class="rowtwo" valign="top">
    ...
    <td>
        <table border="0" width="100%" cellpadding="0" cellspacing="1">
            <tbody><tr valign="top">
                <td width="100%">
                    <textarea name="answer_text[1]" cols="50" rows="3" style="width: 99%;"><?php echo $answer_text[1]; ?></textarea>
                </td>
                <td valign="middle" width="150">


                    <nobr>  <input id='a1' type="radio" value="<?php echo $rdo_value[1]; ?>" class="clsradio" name="QuestionBanks[id_answer]"
                            />
...
<tr class="rowone" valign="top">
    ...
    <td>
        <table border="0" width="100%" cellpadding="0" cellspacing="1">
            <tbody><tr valign="top">
                <td width="100%">
                    <textarea name="answer_text[2]" cols="50" rows="3" style="width: 99%;"><?php echo $answer_text[2]; ?></textarea>
                </td>
                <td valign="middle" width="150">
                    <nobr>  <input id='a2' type="radio"  value="<?php echo $rdo_value[2]; ?>"  class="clsradio"  name="QuestionBanks[id_answer]"
                            />
...
<tr class="rowtwo" valign="top">
    ...
    <td>
        <table border="0" width="100%" cellpadding="0" cellspacing="1">
            <tbody><tr valign="top">
                <td width="100%">
                    <textarea name="answer_text[3]" cols="50" rows="3" style="width: 99%;"><?php echo $answer_text[3]; ?></textarea>
                </td>
                <td valign="middle" width="150">
                    <nobr>  <input id='a4' type="radio"  value="<?php echo $rdo_value[3]; ?>"  class="clsradio"  name="QuestionBanks[id_answer]"
                            />
...
<tr class="rowone" valign="top">
    ...
    <td>
        <table border="0" width="100%" cellpadding="0" cellspacing="1">
            <tbody><tr valign="top">
                <td width="100%">
                    <textarea name="answer_text[4]" cols="50" rows="3" style="width: 99%;"><?php echo $answer_text[4]; ?></textarea>
                </td>
                <td valign="middle" width="150">
                    <nobr>  <input id='a3' type="radio"  value="<?php echo $rdo_value[4]; ?>"  class="clsradio"  name="QuestionBanks[id_answer]"
                            />
...
<p class="center">
    ...
    <input class="btn" name="bsubmit2" value=" Update / create new question " type="submit">
