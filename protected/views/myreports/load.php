                    ...
                    <tbody><tr>
                        <td>
                            <table cellspacing="0" cellpadding="0" border="0">
                                <tbody><tr>
                                    <td width="3">
                                        <img width="3" height="1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif">
                                    </td>
                                    <td>
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="border-left: 1px solid #E0E7F6;
                                            ...
                                            <tbody><tr>
                                                <td height="1" style="background: #ffffff" colspan="3">
                                                    <img width="1" height="1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif">
                                                </td>
                                            </tr>
                                            <tr style="background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/barsmall-1-background.gif) repeat-x;">
                                                <td width="1" style="background: #ffffff">
                                                    <img width="1" height="24" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif">
                                                </td>
                                                <td align="center">
                                                    &nbsp;&nbsp;<b>Report Manager</b>&nbsp;&nbsp;
                                                </td>
                                    ...
                                    <td width="5">
                                        <img width="5" height="1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif">
                                    </td>
                                    <td>
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="border-left: 1px solid #E0E7F6;
                                                                            border-top: 1px solid #E0E7F6; border-right: 1px solid #CFD6E3;">
                        ...
                        <td width="53" align="right">
                            <a title="Show/hide hints bar" href="javascript:ShowInfoBar(true);" id="infobar_button">
                                <img width="24" height="24" border="0" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/dialog-info-small.gif"></a><img width="5" height="1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif"><a target="_blank" title="Help" href="guide/guide.php?language=en&amp;page=test_manager.test_manager" id="helpbar_button"><img width="24" height="24" border="0" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/dialog-help-small.gif"></a>
                        </td>
                        <td width="3">
                            <img width="3" height="1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif">
                        </td>
