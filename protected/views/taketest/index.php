...
<tr valign="top">
    ...
    <td class="rowhdr1" valign="top" title="Question ID (click to sort by)">
        <a class="rowhdr" href="questionbank.html?action=&limitto=50&pageno=1&order=0&direction=DESC">
            ID</a><br>
        <nobr><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-asc.gif" width=10 height=8><a href="questionbank.html?action=&limitto=50&pageno=1&order=0&direction=DESC"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-desc-inactive.gif" width=10 height=8 border=0></a></nobr>
    </td>
    <td class="rowhdr1" valign="top" title="Subject (click to sort by)">
        <a class="rowhdr" href="questionbank.html?action=&limitto=50&pageno=1&order=1&direction=">
            Subject</a><br>
        <nobr><a href="questionbank.html?action=&limitto=50&pageno=1&order=1&direction="><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-asc-inactive.gif" width=10 height=8 border=0></a><a href="questionbank.html?action=&limitto=50&pageno=1&order=1&direction=DESC"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-desc-inactive.gif" width=10 height=8 border=0></a></nobr>
    </td>
    <td class="rowhdr1" valign="top" title="Question">
        Question
    </td>
    <td class="rowhdr1" valign="top" title="Point value (click to sort by)">
        <a class="rowhdr" href="questionbank.html?action=&limitto=50&pageno=1&order=4&direction=">
            Seconds</a><br>
        <nobr><a href="questionbank.html?action=&limitto=50&pageno=1&order=4&direction="><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-asc-inactive.gif" width=10 height=8 border=0></a><a href="questionbank.html?action=&limitto=50&pageno=1&order=4&direction=DESC"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-desc-inactive.gif" width=10 height=8 border=0></a></nobr>
    </td>
