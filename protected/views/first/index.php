...
<div class="vd_body">
    ...
    <header class="header" id="header">
        <div class="container">
            <div class="row header-top">
                <div class="col-md-12">
                    <div class="logo">
                        <a href="index.html"></a><img src="themes/user-theme/images/logo.png"></img>
                    </div>
                    <div class="title-site">
                        <h2 class="title-page">CƠ SỞ KÍNH TÂN PHÚC</h2>
                        <h4 class="title-page">Chuyên thiết kế - kệ kính - kệ tivi - bàn ăn</h4>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="text-right param-underbanner">Phục vụ tận nơi - bảo hành tại chỗ</p>
                </div>
            </div>
        </div>
        <!-- .container -->
    ...
    <footer class="footer"  id="footer">
        <p class="text-center param-underbanner">2015 PRODUST CATALOGUE</a></p>
    </footer>
    <!-- Footer END -->
