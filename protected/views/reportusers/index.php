                ...
                <form name="filterForm" method="post" action="test-manager.html?action=filter">
                    <table class="rowtable2" cellpadding="5" cellspacing="1" border="0" width="100%">
                        <tr class="rowtwo" valign="top">
                            ...
                            <td>
                                <?php echo $form->dropDownList($model, 'id_user', $arr_data_id_user, array('options' => array($m_id_user=>array('selected'=>true)),'tabindex' => 4, 'class' => 'inp')); ?>
                            </td>
                        </tr>
                        <tr class="rowone" valign="top">
                            ...
                            <td>
                                <?php echo $form->dropDownList($model, 'id_exam', $arr_data_id_exam, array('options' => array($m_id_exam=>array('selected'=>true)),'tabindex' => 4, 'class' => 'inp')); ?>
                            </td>
                        </tr>
                    </table>
                    <br>
                    <input class="btn" type="submit" name="bsetfilter" value=" Set filter ">
                    <input class="btn" type="button"  onclick="javascript:window.location='index.php?r=reportusers/index'" name="bremovefilter" value=" Remove filter ">
                    <input class="btn" type="button"  onclick="javascript:window.location='index.php?r=reportusers/export'" name="bremovefilter" value=" Export CSV ">
                    <input class="btn" type="button"  onclick="javascript:window.location='index.php?r=reportusers/pdf'" name="bremovefilter" value=" Export PDF ">
                </form>
            </div>
        </td>
    </tr>
            ...
            <tr valign="center">
                ...
                <td width="32">
                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-cross-big.gif" border="0" title="Delete tests (for selected records)"
                         style="cursor: hand;" onclick="f=document.testsForm;if (confirm('Are you sure want to delete selected tests?')) { f.action='<?php echo Yii::app()->baseUrl; ?>/index.php?r=reportmanager/delete&all=0';f.submit();}">
                </td>
                <td width="70%">
                    &nbsp;
                </td>
    ...
    ?>
        <tr id="tr_<?php echo $numberRow ?>" class="<?php echo $classRow ?>" onmouseover="rollTR(0,1);" onmouseout="rollTR(0,0);">
            <td align="center" width="22">
                <input id="cb_<?php echo $value['id'] ?>" type="checkbox" name="box_exams[]" value="<?php echo $value['id'] ?>" onclick="toggleCB(this);">
            </td>
            ...
            <td align="center" width="22">
                <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=reportusers/load&id_user=<?php echo $value['id_user'] ?>&id_exam=<?php echo $value['id_exam'] ?>">
                    <img width="20" height="20" border="0" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-view.gif" title="View detail exam"></a>
            </td>
            <td align="center" width="22">
                <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=reportmanager/delete&id=<?php echo $value['id'] ?>" onclick="return confirmMessage(this, 'Are you sure want to delete this exam?')">
                    <img width="20" height="20" border="0" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-cross.gif" title="Delete this exam"></a>
            </td>
        </tr>
        <?php endforeach?>
    <?php endif?>
