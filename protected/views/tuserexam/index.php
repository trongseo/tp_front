            ...
            <td class="rowone" colspan="2">
                <div id="div_filter_testmanager"  style="display: block">
                    <form name="filterForm" method="post" action="test-manager.html?action=filter">
                        ...
                        <input class="btn" type="button"  onclick="javascript:window.location='index.php?r=tuserexam'" name="bremovefilter" value=" Remove filter ">
                    </form>
                </div>
            </td>
        </tr>
                ...
                <td>
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/toolbar-background.gif) repeat-x">
                        <tr valign="center">
                            ...
                            <td width="32">
                                <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=tuserexam/create">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-new-big.gif" width="32" height="32" border="0" title="Create a new exam"></a>
                            </td>
                            <td width="3">
                            ...
                            <td width="32">
                                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-cross-big.gif" border="0" title="Delete tests (for selected records)"
                                     style="cursor: hand;" onclick="f=document.testsForm;if (confirm('Are you sure want to delete selected tests?')) { f.action='<?php echo Yii::app()->baseUrl; ?>/index.php?r=tuserexam/delete&all=0';f.submit();}">
                            </td>
                            <td width="70%">
                                &nbsp;
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td class="rowhdr1" valign="top" title="Test ID (click to sort by)">
                                ...
                                <nobr><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-asc.gif" width=10 height=8>
                                    <a href="test-manager.html?action=&limitto=50&pageno=1&order=0&direction=DESC">
                                        <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-order-desc-inactive.gif" width=10 height=8 border=0></a></nobr>
                            </td>
                        ...
                        <?php if ($items['models']): ?>
                            <?php foreach($items['models'] as $value):?>
                                ...
                                <tr id="tr_<?php echo $numberRow ?>" class="<?php echo $classRow ?>" onmouseover="rollTR(0,1);" onmouseout="rollTR(0,0);">
                                    ...
                                    <td align="center" width="22">
                                        <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=tuserexam/delete&id=<?php echo $value['id'] ?>" onclick="return confirmMessage(this, 'Are you sure want to delete this test?')">
                                            <img width="20" height="20" border="0" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-cross.gif" title="Delete this test"></a>
                                    </td>
                                </tr>
                            <?php endforeach?>
                        <?php endif?>
