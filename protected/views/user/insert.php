        ...
        <td class="box_area">
            ...
            <table class="rowtable2" border="0" width="50%" cellpadding="5" cellspacing="1">
                ...
                <tr class="rowtwo" valign="top">
                    ...
                    <td>
                        <?php echo $form->textField($model, 'email', array( 'class'=>'inp','size'=>'30')); ?> <label style="color: #ff0000">*</label>
                    </td>
                </tr>
                <tr class="rowone" valign="top">
                    <td>
                    ...
                    <td>
                        <?php echo $form->textField($model, 'password', array( 'class'=>'inp','size'=>'30')); ?> <label style="color: #ff0000">*</label>
                    </td>
                </tr>
                <tr class="rowtwo" valign="top">
                    <td>
                ...
                <tr class="rowone" valign="top">
                    ...
                    <td>
                        <?php echo $form->textField($model, 'birthday', array( 'class'=>'inp','id'=>'date_input_1','readonly'=>'readonly')); ?>
