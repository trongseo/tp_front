                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="border-left: 1px solid #E0E7F6;
                            ...
                            <tr style="background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/barsmall-1-background.gif) repeat-x;">
                                ...
                                <td align="center">
                                    &nbsp;&nbsp;<b><a class="bar2" href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=tuserexam/index">Exam of users</a></b>&nbsp;&nbsp;
                                </td>
                                <td width="1" style="background: #ffffff">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/1x1.gif" width="1" height="24">
                                </td>
        ...
        <td class="rowone" colspan="2">
            <div id="div_filter_testmanager"  style="display: block">
                <form name="filterForm" method="post" action="test-manager.html?action=filter">
                    ...
                    <input class="btn" type="button"  onclick="javascript:window.location='index.php?r=testmanagers'" name="bremovefilter" value=" Remove filter ">
                </form>
            </div>
        </td>
    </tr>
    ...
    <td>
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: url(<?php echo Yii::app()->theme->baseUrl; ?>/images/toolbar-background.gif) repeat-x">
            <tr valign="center">
                ...
                <td width="32">
                    <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=testmanagers/insert">
                ...
                <td width="32">
                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-cross-big.gif" border="0" title="Delete tests (for selected records)"
                         style="cursor: hand;" onclick="f=document.testsForm;if (confirm('Are you sure want to delete selected tests?')) { f.action='<?php echo Yii::app()->baseUrl; ?>/index.php?r=testmanagers/delete&all=0';f.submit();}">
                </td>
                <td width="70%">
                    &nbsp;
                </td>
...
<tr valign="top">
    ...
    ?>
        <tr id="tr_<?php echo $numberRow ?>" class="<?php echo $classRow ?>" onmouseover="rollTR(0,1);" onmouseout="rollTR(0,0);">
            ...
            <td align="center" width="22">
                <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=testmanagers/edit&id=<?php echo $value['id'] ?>"">
                    <img width="20" height="20" border="0" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/button-edit.gif" title="Edit questions"></a>
            </td>
            <td align="center" width="22">
                <a href="<?php echo Yii::app()->baseUrl; ?>/index.php?r=testmanagers/delete&id=<?php echo $value['id'] ?>" onclick="return confirmMessage(this, 'Are you sure want to delete this test?')">
