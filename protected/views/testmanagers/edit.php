                ...
                <tbody><tr>
                            ...
                            <tbody><tr>
                                ...
                                <td>
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0" style="border-left: 1px solid #E0E7F6;
                                        ...
                                        <tbody><tr>
                                            <td height="1" colspan="3" style="background: #ffffff">
                                        ...
                                        <tr style="background: url(/dos_webacb/themes/admin-green/images/barsmall-0-background.gif) repeat-x;">
                                            ...
                                            <td align="center">
                                                &nbsp;&nbsp;<b><a class="bar2" href="/dos_webacb/index.php?r=testmanagers/index">Exam Manager </a></b>&nbsp;&nbsp;
                                            </td>
                                            <td width="1" style="background: #ffffff">
                                                <img width="1" height="24" src="/dos_webacb/themes/admin-green/images/1x1.gif">
                                            </td>
                    ...
                    <td width="53" align="right">
                        <a id="infobar_button" href="javascript:ShowInfoBar(true);" title="Show/hide hints bar">
                            <img width="24" height="24" border="0" src="/dos_webacb/themes/admin-green/images/dialog-info-small.gif"></a><img width="5" height="1" src="/dos_webacb/themes/admin-green/images/1x1.gif"><a id="helpbar_button" href="guide/guide.php?language=en&amp;page=question_bank.question_bank.edit_question" title="Help" target="_blank"><img width="24" height="24" border="0" src="/dos_webacb/themes/admin-green/images/dialog-help-small.gif"></a>
                    </td>
                    <td width="3">
                        <img width="3" height="1" src="/dos_webacb/themes/admin-green/images/1x1.gif">
                    </td>
